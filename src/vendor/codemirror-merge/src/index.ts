...
export {addChangedLineDecoration, addChunkDecorations, changedText, refreshChunkDecorationsEffect, refreshInlineChangeLayerEffect, uncollapseUnchanged, mergeViewSiblings} from "./deco"
